...
export class DemosComponent implements OnInit {
  ...
  markerConfig = {
    ...
    "15": { color: "red", size: 4, type: "line", labelColor: "green" },
    "30": {
      color: "red",
      size: 8,
      label: "30",
    ...
    "40": { color: "red", size: 4, type: "line", labelColor: "green" },
    "50": {
      color: "red",
      size: 8,
      label: "50",
    ...
    "60": { color: "red", size: 4, type: "line", labelColor: "green" },
    "70": {
      color: "red",
      size: 8,
      label: "70",
    ...
    "85": { color: "red", size: 4, type: "line", labelColor: "green" },
    "100": {
      color: "red",
      size: 8,
      label: "100",
